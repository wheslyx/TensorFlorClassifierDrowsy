...
def draw_bounding_box_on_image(image,
  ...
  print("[Box Corners]:left, right, top, bottom")
  corners = np.array([left, right, top, bottom])
  print(corners)
  text_bottom = top
    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          ...
          display_str = '{}: {}%'.format(class_name, confidence)
          print("Detection Score:")
          print(confidence)  
        else:
          
          display_str = 'score: {}%'.format(confidence)
